package com.sardari.daterangepicker.customviews;//package com.archit.calendardaterangepicker.customviews;
//
...
//import com.archit.calendardaterangepicker.utils.PersianCalendar;
//
...
// */
//
//public class DateRangeCalendarView_BK extends LinearLayout {
//    private static final String LOG_TAG = DateRangeCalendarView_BK.class.getSimpleName();
...
//
//    private Calendar currentCalendarMonth, minSelectedDate, maxSelectedDate;
//
...
//    }
//
//    public DateRangeCalendarView_BK(Context context) {
//        super(context);
//        initView(context, null);
//    }
//
//    public DateRangeCalendarView_BK(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        initView(context, attrs);
//    }
//
//    public DateRangeCalendarView_BK(Context context, AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        initView(context, attrs);
//    }
//
//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public DateRangeCalendarView_BK(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                        DateRangeCalendarView_BK.this.resetAllSelectedViews();
//                    }
//                });
